...
def run_model(model, data_loader):
    ...
    with torch.no_grad():
        for idx, (he_img, he_pos, ihc_img, ihc_pos, label) in enumerate(data_loader):
            ...
            pred = model(he_img, he_pos, ihc_img, ihc_pos, stain_embed=False, pos_embed=True)
...
if __name__ == "__main__":
    ...
    model_dict_path = "checkpoints/2025-06-15 22.47.12_DualInputViT_ep99.pth"  # Change this to the right model path
    model_id = '_06-15_22.47_e99'  # Change this to the right model ID
    ...
    eval_loader = DataLoader(eval_dataset, shuffle=False, worker_init_fn=seed_worker, generator=g)
